...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO student (name, Father, DOB, MOBILE_NO, BLOOD_GRP, EMAIL, PASSWORD)
            VALUES ('$name', '$Father', '$DOB', '$MOBILE_NO', '$BLOOD_GRP', '$EMAIL', '$password')";
    ...
    <form method="post" action="#">
        <div class="col-md-8 offset-md-2">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Father" id="Father_name" placeholder="Enter Father's Name">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="MOBILE_NO" id="Mobilenumber" placeholder="Enter Mobile Number" required>
            </div>
            ...
            <div class="d-flex justify-content-center">
                <button type="submit" class="btn btn-primary mx-2" name="submit" style=margin:10px>Submit</button>
